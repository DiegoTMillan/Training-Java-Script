...
//Exercise 5 ESTÁ MAL, NO FUNCIONA
// let absoluteZero = 273.15;
// let freezingPoint = 0;
// let bodyTemperature = 37;
// let boillingPoint = 100; 
// let celsius = absoluteZero || freezingPoint || boillingPoint || bodyTemperature;
// let resultado = celsius * 9/5 + 32;

// switch (resultado){
//   case absoluteZero == (273.15 *1.8 + 32):
//     console.log(fahrenhait);
//     break;
//   case freezingPoint = (0 * 1.8 + 32):
//     console.log(freezingPoint , "ºF");
//     break;
//   case bodyTemperature = (37 * 1.8 + 32):
//     console.log(bodyTemperature , "ºF");
//     break;
//   case boillingPoint = (100 * 1.8 + 32):
//     console.log(boillingPoint , "ºF")
// }

//Exercise 6
// let email = "tolkien@lordofrings.com";
// let password = "aNBR6ZeWPY";
// let emailCheck = prompt("Please, insert your email");
// let passwordCheck = prompt ("Please insert your password");
