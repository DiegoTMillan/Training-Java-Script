...
console.log(curiosities[randomNumber(0,19)]);
  let timerId = setInterval(() => console.log(curiosities[randomNumber(0, 19)]), 15000);
  setTimeout(() => { clearInterval(timerId); console.log('Y aquí terminan las curiosidades, espero que las hayas disfrutado'); }, 120000);
}
}
